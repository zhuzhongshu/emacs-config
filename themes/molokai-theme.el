...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(company-tooltip ((,class (:background ,"#073642" :foreground ,"#2aa198"))))
   `(company-tooltip-selection ((,class (:background ,"#00736F" :foreground ,"#69CABF"))))
   `(company-tooltip-mouse ((,class (:background ,"#69CABF" :foreground ,"#00736F"))))
   `(company-tooltip-common ((,class (:foreground , "#93a1a1" :underline t))))
   `(company-tooltip-common-selection ((,class (:foreground , "#93a1a1" :underline t))))
   `(company-scrollbar-fg ((,class (:foreground ,"#002b36" :background , "#839496"))))
   `(company-scrollbar-bg ((,class (:background ,"073642" :foreground ,"#2aa198"))))
   `(company-preview ((,class (:background ,"073642" :foreground ,"#2aa198"))))
   `(company-preview-common ((,class (:foreground , "#93a1a1" :underline t))))
