...
Takes and optional `FRAME' as reference."
  (let* ((class '((class color) (min-colors 89)))
         ...
         (cyan             (if (in-terminal) "#5FFFFF" "#31DBC3"))
         (green            (if (in-terminal) "#87D700" "#94C929"))
         ...
         ;; Adaptive colors
         (monokai-fg       (if (in-terminal) "#F5F5F5" "#7A9496"))
         (monokai-bg       (if (in-terminal) "#1B1E1C" "#002B36"))
         (monokai-hl-line  (if (in-terminal) "#212121" "#293739"));;modify!
         (monokai-hl       (if (in-terminal) "#303030" "#232526"))
         (monokai-emph     (if (in-terminal) "#FFFAFA" "#BCBCBC"))
         (monokai-comments (if (in-terminal) "#8B8878" "#808080"))
    ...
    (custom-theme-set-faces
     ...
     `(flycheck-warning
       ((,(append '((supports :underline (:style wave))) class)
         (:underline (:style wave :color ,yellow)
                     :inherit unspecified))
        (,class (:foreground ,orange-lc
                             :background ,orange-hc
                             :weight bold
                             :underline t))))
     ...
     ;; `(helm-selection ((t (:background ,monokai-grey+2
     ;;                                   :underline nil))))
     ...
     `(helm-separator
       ((,class (:foreground ,solarized-red
                             :bold t))))
     ...
     `(popup-menu-face
       ((,class (:background ,solarized-green
                             :foreground ,"black"))))
     ...
     `(rainbow-delimiters-depth-3-face
       ((,class (:foreground ,solarized-green))))

     `(rainbow-delimiters-depth-4-face
       ((,class (:foreground ,solarized-pink))))

     `(rainbow-delimiters-depth-5-face
       ((,class (:foreground ,solarized-blue))))

     `(rainbow-delimiters-depth-6-face
       ((,class (:foreground ,solarized-yellow))))

     `(rainbow-delimiters-depth-7-face
       ((,class (:foreground ,solarized-ivory))))

     `(rainbow-delimiters-depth-8-face
       ((,class (:foreground ,solarized-magenta))))

     `(rainbow-delimiters-depth-9-face
       ((,class (:foreground ,solarized-violet))))
     ...
     ;;   ((,class (:weight bold))))
     ;; `(sml/sudo
     ;;   ((,class (:foreground ,solarized-orange :weight bold))))
     ;; `(sml/read-only
     ;;   ((,class (:foreground ,solarized-cyan))))
     ...
     ;;   ((,class (:foreground ,monokai-fg))))
     ;; `(sml/discharging
     ;;   ((,class (:foreground ,monokai-fg :weight bold))))
